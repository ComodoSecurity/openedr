...
//
// Object acquires a macros_oss from per_thread_data,
// get() returns a new stream if macros_oss is busy.
// All resources are freed automatically when a guard
// object is being destroyed.
//
struct macro_oss_guard
{
private:
	std::unique_ptr<log4cplus::tostringstream> m_oss;
...
public:
	...
	macro_oss_guard(const macro_oss_guard&) = delete;
	macro_oss_guard(macro_oss_guard&&) = delete;
	macro_oss_guard& operator=(const macro_oss_guard&) = delete;
	macro_oss_guard& operator=(macro_oss_guard&&) = delete;

	log4cplus::tostringstream& get();
};
...
#else
#  if defined (LOG4CPLUS_MACRO_USE_GUARD)
#    define LOG4CPLUS_MACRO_INSTANTIATE_OSTRINGSTREAM(var)  \
       log4cplus::detail::macro_oss_guard __var__;          \
       log4cplus::tostringstream & var = __var__.get()
#  else
#    define LOG4CPLUS_MACRO_INSTANTIATE_OSTRINGSTREAM(var)  \
      log4cplus::tostringstream & var                       \
